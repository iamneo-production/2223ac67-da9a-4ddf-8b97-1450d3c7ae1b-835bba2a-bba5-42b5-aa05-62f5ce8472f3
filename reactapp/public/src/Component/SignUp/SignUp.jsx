...
export default function SignUp() {
  ...
  return (
    ...
    NAME <br/> <input type="text" value={name} placeholder="" onChange={e=>setName(e.target.value)}/><br/>
    <div>
    {error && name.length===0?
      <label style={{color:'red'}}>Name is required</label>:""} 
    </div><br/>
    MOBILE NUMBER<br/><input type="number" value={phno} placeholder="" onChange={e=>setMobileNum(e.target.value)}/><br/>
    <div>
...
{error && !gender ? 
  <label style={{ color: 'red' }}>Gender is required</label>:""}
    ...
    E-MAIL ID<br/><input type="email" value={emailid} placeholder="" onChange={e=>setEmail(e.target.value)}/><br/>
    <div>
    {error && emailid.length===0?
      <label style={{color:'red'}}>E-mail ID is required</label>:""} 
    </div><br/>
    PASSWORD<input type="password" value={password} placeholder="" onChange={e=>setPassword(e.target.value)}/><br/>
    <div>
    {error && password.length===0?
      <label style={{color:'red'}}>Password is required</label>:""}
    </div><br/>
    CONFIRM PASSWORD<input type="password" value={confirmpassword} placeholder="" onChange={e=>setConfirmPassword(e.target.value)}/><br/>
    <div>
